...
class _BitCondition(_Condition):
    def write(self, address: int, bit: int, true: list | None, false: list | None):
        if true is None:
            true = []
        if false is None:
            false = []
...
class CharacterCondition(_BitCondition):
    def write(self, character: int, true: list | None = None, false: list | None = None):
...
class EsperCondition(_BitCondition):
    def write(self, esper: int, true: list | None = None, false: list | None = None):
